...
export default class Ecs extends React.Component {
    render() {
        return (
            <Grid>
                <Title text="Electronic Catalog System" />
                <AccentSeparator />
                <ProjectDescription text="User experience research and design" />
                <ProjectDescription text="for UW IT department employees" />
                <UnifyHeaderImage />
